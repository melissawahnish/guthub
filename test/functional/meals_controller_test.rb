...
class MealsControllerTest < ActionController::TestCase
  ...
  test "should create meal" do
    assert_difference('Meal.count') do
      post :create, meal: { course: @meal.course, cuisine: @meal.cuisine, flavor: @meal.flavor, name: @meal.name }
    end
  ...
  test "should update meal" do
    put :update, id: @meal, meal: { course: @meal.course, cuisine: @meal.cuisine, flavor: @meal.flavor, name: @meal.name }
    assert_redirected_to meal_path(assigns(:meal))
  end
